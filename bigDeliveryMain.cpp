...
//(*InternalHeaders(bigDeliveryFrame)
#include <wx/intl.h>
...
//(*IdInit(bigDeliveryFrame)
const long bigDeliveryFrame::ID_CUSTOM1 = wxNewId();
const long bigDeliveryFrame::ID_CUSTOM2 = wxNewId();
const long bigDeliveryFrame::ID_TEXTCTRL1 = wxNewId();
const long bigDeliveryFrame::ID_BUTTON1 = wxNewId();
const long bigDeliveryFrame::ID_BUTTON2 = wxNewId();
const long bigDeliveryFrame::ID_BUTTON3 = wxNewId();
const long bigDeliveryFrame::ID_TOGGLEBUTTON1 = wxNewId();
const long bigDeliveryFrame::ID_BUTTON8 = wxNewId();
const long bigDeliveryFrame::ID_BUTTON4 = wxNewId();
const long bigDeliveryFrame::ID_BUTTON5 = wxNewId();
const long bigDeliveryFrame::ID_BUTTON6 = wxNewId();
const long bigDeliveryFrame::ID_TOGGLEBUTTON2 = wxNewId();
const long bigDeliveryFrame::ID_BUTTON7 = wxNewId();
const long bigDeliveryFrame::ID_MENUITEM1 = wxNewId();
const long bigDeliveryFrame::idMenuAbout = wxNewId();
const long bigDeliveryFrame::ID_STATUSBAR1 = wxNewId();
const long bigDeliveryFrame::ID_TIMER1 = wxNewId();
//*)

BEGIN_EVENT_TABLE(bigDeliveryFrame,wxFrame)
    //(*EventTable(bigDeliveryFrame)
    //*)
END_EVENT_TABLE()

bigDeliveryFrame::bigDeliveryFrame(wxWindow* parent, wxWindowID id, BotModel* _botData)
	: botData(_botData)
{
    //(*Initialize(bigDeliveryFrame)
    ...
    Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&bigDeliveryFrame::OnbtnStartClick);
    Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&bigDeliveryFrame::OnbtnManualClick);
    Connect(ID_BUTTON3,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&bigDeliveryFrame::OnbtnResetClick);
    Connect(ID_BUTTON8,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&bigDeliveryFrame::OnbtnSetWaypointsToggle);
    Connect(ID_BUTTON4,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&bigDeliveryFrame::OnbtnStopClick);
    Connect(ID_BUTTON5,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&bigDeliveryFrame::OnbtnAutoClick);
    Connect(ID_BUTTON6,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&bigDeliveryFrame::OnbtnLoadMapClick);
	Connect(ID_TOGGLEBUTTON1,wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,(wxObjectEventFunction)&bigDeliveryFrame::OnbtnSetTargetToggle);
    Connect(ID_TOGGLEBUTTON2,wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,(wxObjectEventFunction)&bigDeliveryFrame::OnbtnSetWaypointsToggle);
    Connect(ID_BUTTON7,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&bigDeliveryFrame::OnbtnResetPDFClick);
    Connect(ID_MENUITEM1,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&bigDeliveryFrame::OnQuit);
    Connect(idMenuAbout,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&bigDeliveryFrame::OnAbout);
    Connect(ID_TIMER1,wxEVT_TIMER,(wxObjectEventFunction)&bigDeliveryFrame::OntimUpdate3DTrigger);
    //*)
	...
	m_plot3D->Connect(wxEVT_MOTION, (wxObjectEventFunction)&bigDeliveryFrame::Onplot3DMouseMove, 0, this);
	m_plot3D->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&bigDeliveryFrame::Onplot3DMouseClick, 0, this);
	m_plot3D->Connect(wxEVT_RIGHT_DOWN, (wxObjectEventFunction)&bigDeliveryFrame::Onplot3DMouseClick, 0, this);
...
bigDeliveryFrame::~bigDeliveryFrame()
{
    //(*Destroy(bigDeliveryFrame)
    //*)
}

void bigDeliveryFrame::updateMap3DView()
{
	gl_grid->clear();
	botData->metricMap.getAs3DObject(gl_grid);
}

void bigDeliveryFrame::updateOpenglObjects()
{
	WX_START_TRY

	if (!botData->allThreadsMustExit)
	{
		poses::CPose2D loc;
...
void bigDeliveryFrame::Onplot3DMouseMove(wxMouseEvent& event)
{
	int X, Y;
...
void bigDeliveryFrame::Onplot3DMouseClick(wxMouseEvent& event)
{
...
void bigDeliveryFrame::OnAbout(wxCommandEvent& event)
{
    wxString msg = wxbuildinfo(long_f);
    wxMessageBox(msg, _("Welcome to..."));
}

void bigDeliveryFrame::OnbtnStartClick(wxCommandEvent& event)
{
...
void bigDeliveryFrame::OnbtnStopClick(wxCommandEvent& event)
{
...
void bigDeliveryFrame::OnbtnManualClick(wxCommandEvent& event)
{
...
void bigDeliveryFrame::OnbtnAutoClick(wxCommandEvent& event)
{
...
void bigDeliveryFrame::OnbtnLoadMapClick(wxCommandEvent& event)
{
}

void bigDeliveryFrame::OnbtnSetTargetToggle(wxCommandEvent& event)
{
...
void bigDeliveryFrame::OntimUpdate3DTrigger(wxTimerEvent& event)
{
	this->updateOpenglObjects();

}

void bigDeliveryFrame::OnbtnResetClick(wxCommandEvent& event)
{
	m_gl_placing_nav_target->setVisibility(false);
	gl_target->setVisibility(false);
	m_waypoints_clicked.clear();
...
void bigDeliveryFrame::OnbtnSetWaypointsToggle(wxCommandEvent& event)
{
...
void bigDeliveryFrame::OnbtnFindPathClick(wxCommandEvent& event)
{
}

void bigDeliveryFrame::OnbtnResetPDFClick(wxCommandEvent& event)
{
	WX_START_TRY
